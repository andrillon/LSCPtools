...
real_out=[double(model.Coefficients(2,2)) double(model.Coefficients(2,4)) double(model.Coefficients(2,6))];
...
for np=1:totperm
    ...
    perm_out(np,:)=[double(model.Coefficients(2,2)) double(model.Coefficients(2,4)) double(model.Coefficients(2,6)) np];
