function [hdot pV]=simpleDotPlot(Pos,data,sizeDot,colorBar,widthBar,colorError,sigFlag,widthLine)
% INPUT:
...
if sigFlag{1}==1
    ...
    hdot=scatter(Pos,nanmean(data),'MarkerFaceColor',colorBar(1,:),'MarkerEdgeColor',colorBar(2,:),'LineWidth',widthLine,'SizeData',sizeDot);
elseif sigFlag{1}==2
    ...
    hdot=scatter(Pos,nanmedian(data),'MarkerFaceColor',colorBar(1,:),'MarkerEdgeColor',colorBar(2,:),'LineWidth',widthLine,'SizeData',sizeDot);
