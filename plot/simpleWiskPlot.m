function [hbar pV]=simpleWiskPlot(Pos,data,colorBar,widthBar,colorError,sigFlag,widthLine)
...
hold on;
if sigFlag{1}==1
    hbar=boxplot(Pos,(data),'BarWidth',widthBar,'FaceColor',colorBar(1,:),'EdgeColor',colorBar(2,:),'LineWidth',widthLine);
