...
function [spindles spindlesOutEnergy spindlesOutDuration] = SpindlesDetectionAlgorithm_forSPM12(D, SleepScoring_filename, paramDetection)
...
if isfield(paramDetection,'minMaxDurations_ms'),  minMaxDurations_ms=paramDetection.minMaxDurations_ms;   else minMaxDurations_ms=[0.5 2.5]; end
...
for nChan=ChannelSelection
    ...
    if isempty(SleepScoring_filename)
        ...
        [SleepStages_ts arousal_sampled marousal_sampled]=format_sleepScoring(D,SleepScoring_filename);
        if NREMonlyForThr
